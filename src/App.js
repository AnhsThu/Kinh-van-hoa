    ...
    <>
      {loading && index !== 0 &&
        <div className="fixed top-0 left-0 right-0 bottom-0 w-full h-screen z-50 overflow-hidden bg-gray-700 opacity-75 flex flex-col items-center justify-center">
          ...
          <p className="w-1/3 text-center text-white">Đừng lóng, chờ 1 xíu là tải xong...</p>
        </div>
      }
...

          {
            index === 0 ?
              <>
                ...
                <a
                  target='_blank'
                  href="https://github.com/AnhsThu/Kinh-van-hoa"
              ...
              <div className='flex flex-col gap-y-2 mb-2'>
                ...
                >
                  {
                    images.map((image, index) => <option key={index} value={index}>{image.title}</option>)
                  }
                </select>
              </div>
          }
